...
public extension Tab where Value: Hashable, Content: View, Label == DefaultTabLabel {
    ...
    ///     - content: The view content of the tab.
    @_disfavoredOverload
    nonisolated init<S: StringProtocol>(_ title: S, systemSymbol: SFSymbol, value: Value, @ViewBuilder content: () -> Content) {
...
public extension Tab where Value == Never, Content: View, Label == DefaultTabLabel {
    ...
    ///     - content: The view content of the tab.
    @_disfavoredOverload
    nonisolated init<S: StringProtocol>(_ title: S, systemSymbol: SFSymbol, @ViewBuilder content: () -> Content) {

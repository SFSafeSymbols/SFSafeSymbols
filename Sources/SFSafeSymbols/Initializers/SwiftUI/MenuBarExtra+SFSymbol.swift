...
public extension MenuBarExtra where Label == SwiftUI.Label<Text, Image> {
    ...
    nonisolated init(_ titleKey: LocalizedStringKey, systemSymbol: SFSymbol?, @ViewBuilder content: () -> Content) {
    ...
    /// - Parameter content: A `View` to display when the user selects the item.
    nonisolated init(_ titleKey: LocalizedStringKey, systemSymbol: SFSymbol?, isInserted: Binding<Bool>, @ViewBuilder content: () -> Content) {
    ...
    /// - Parameter content: A `View` to display when the user selects the item.
    @_disfavoredOverload
    nonisolated init(_ title: some StringProtocol, systemSymbol: SFSymbol?, @ViewBuilder content: () -> Content) {
    ...
    /// - Parameter content: A `View` to display when the user selects the item.
    @_disfavoredOverload
    nonisolated init(_ title: some StringProtocol, systemSymbol: SFSymbol?, isInserted: Binding<Bool>, @ViewBuilder content: () -> Content) {
